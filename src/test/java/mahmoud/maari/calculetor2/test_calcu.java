...
public class test_calcu {
	...
	public void test_cal() {
		...
		Calcouletor cal = new Calcouletor(n1, "+", n2, r);
		double expected=15;
		double actual =cal.add(n1, n2, r);
	...
	public void test_cal2() {
		...
		Calcouletor cal = new Calcouletor(n1, "*", n2, r);
		double expected=50;
		double actual =cal.malt(n1, n2, r);
		assertEquals(expected, actual,0);
	...
	public void test_cal3() {
		...
		Calcouletor cal = new Calcouletor(n1, "*", n2, r);
		double expected=5;
		double actual =cal.deva(n1, n2, r);
		assertEquals(expected, actual,0);
